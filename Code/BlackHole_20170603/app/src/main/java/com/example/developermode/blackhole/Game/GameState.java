            ...
            if(plnt.m_iHP <= 0) {
                ...
                for(int r = 0; r < 6; r++) {
                    m_EffectManager.RegisterEffectObj(new CollisionLineParticleEffect(
                            plnt.GetX(),
                            plnt.GetY(),
                            (float)Math.cos(Math.toRadians(360.0f/6.0f * r)), (float)Math.sin(Math.toRadians(360.0f/6.0f * r)),
                            plnt.m_fMass / 2.0f,
                            1.6f));
                }
            ...
            for(int j = i + 1; j < m_PlanetList.size(); j++) {
                if(CollisionTool.IsCollided(m_PlanetList.get(i).GetX(), m_PlanetList.get(i).GetY(), m_PlanetList.get(i).m_fRadius,
                    ...
                    m_EffectManager.RegisterEffectObj(new CollisionLineParticleEffect(
                            ...
                            fDirToJ.x, fDirToJ.y,
                            CollisionTool.GetDistance(f2J, new Float2(0.0f, 0.0f)) / 2500.0f,
