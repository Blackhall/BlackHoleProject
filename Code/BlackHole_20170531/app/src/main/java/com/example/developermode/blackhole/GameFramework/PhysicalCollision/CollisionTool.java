...
public class CollisionTool {
    ...
    public static boolean IsCollided(Rect rect, int fX, int fY) {
        if(rect.contains(fX, fY)) return true;
        else return false;
    }
    ...
    public static void ImpurseBasedCollisionResolution(Planet _plnt1, Planet _plnt2, Float2 _f2J)
    {
        // 충돌을 확인한다.
