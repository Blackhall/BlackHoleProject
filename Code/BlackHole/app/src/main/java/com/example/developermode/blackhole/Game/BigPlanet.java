...
public class BigPlanet extends Planet {
    public BigPlanet() {
        ...
        Float2 _max = new Float2(100.0f * 4.0f, 100.0f * 4.0f);
        Float2 _min = new Float2(-100.0f * 4.0f, -100.0f * 4.0f);
        m_AABB = new AABB(_max, _min);

        this.SetPosition(1440/2, 2560/2);
        this.InitSpriteData((int)(200 * 4.0f), (int)(200 * 4.0f), 1, 1);

        m_fRadius = 100.0f * 4.0f;
        m_fMass = 40.0f;
        m_iHP = 1500;
    }
