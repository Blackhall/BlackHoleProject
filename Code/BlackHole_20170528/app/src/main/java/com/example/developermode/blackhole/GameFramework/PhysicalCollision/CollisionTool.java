...
public class CollisionTool {
    ...
    public static void ImpurseBasedCollisionResolution(Planet _plnt1, Planet _plnt2)
    {
        ...
        f2J.x = -(_plnt1.GetVelocity().x - _plnt2.GetVelocity().x) * (1.0f + 0.9f) * ((_plnt1.GetMass() * _plnt2.GetMass())/(_plnt1.GetMass() + _plnt2.GetMass()));
        f2J.y = -(_plnt1.GetVelocity().y - _plnt2.GetVelocity().y) * (1.0f + 0.9f) * ((_plnt1.GetMass() * _plnt2.GetMass())/(_plnt1.GetMass() + _plnt2.GetMass()));
